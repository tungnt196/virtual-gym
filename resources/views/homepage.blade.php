                    ...
                    <div class="owl-wrapper-outer">
                        <div class="owl-wrapper" style="width: 100%; left: 0px; display: block;">
                            <div class="owl-item" style="width: 285px;">
                                <div class="item">
                                    <a href="#"><img src="http://starfitnesshcm.com/img.php?pic=bG9waG9jL0JvZHljb21iYXQuanBn&amp;w=500&amp;h=500&amp;encode=1" alt=""></a>
                                    <h3 class="title">LES MILLS</h3>
                                    <p class="sapo"></p>
                                </div>
                            </div>
                            <div class="owl-item" style="width: 285px;">
                                <div class="item">
                                    <a href="#"><img src="http://starfitnesshcm.com/img.php?pic=WU9HQS9ZT0dBLmpwZw==&amp;w=500&amp;h=500&amp;encode=1" alt=""></a>
                            ...
                            <div class="owl-item" style="width: 285px;">
                                <div class="item">
                                    <a href="#"><img src="http://starfitnesshcm.com/img.php?pic=R1JPVVAgWC9adW1iYS5qcGc=&amp;w=500&amp;h=500&amp;encode=1" alt=""></a>
                                    <h3 class="title">GROUP X</h3>
                                    <p class="sapo"></p>
                                </div>
                            </div>
                            <div class="owl-item" style="width: 285px;">
                                <div class="item">
                                    <a href="#"><img src="http://starfitnesshcm.com/img.php?pic=R1JPVVAgWC9HUkFQLmpwZw==&amp;w=500&amp;h=500&amp;encode=1" alt=""></a>
                                    <h3 class="title">LỚP VÕ THUẬT</h3>
                                    <p class="sapo"></p>
                                </div>
                            </div>
                        </div>
